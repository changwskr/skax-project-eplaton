...
public class DCResourceCopy implements IDomainComponent {
	...
	public List getListResourceInfo(ResourceCopyDDTO rsrcCopyDDTO) throws BusinessException {
		...
		try {
			String cmd = "/fscm/SRC/fsapp/ifr_dev/script/f_t.sh "+rsrcCopyDDTO.getUapplDstcd()+"  "+rsrcCopyDDTO.getCmpoIdnfr()+"  "+rsrcCopyDDTO.getFileIdnfr()+"  "+rsrcCopyDDTO.getKywrCtnt();
	...
	public void copyResource(ResourceCopyDDTO[] rsrcCopyDDTOs) throws BusinessException {
